                ...
                <SettingsCard delay={0.1}>
                  ...
                  {authed && (
                    <div style={{
                      ...
                      <div>
                        <strong>{t('settings.account.privateWarningTitle', 'Private Profile Notice')}</strong>
                        <div style={{ opacity: 0.9, marginTop: 4, lineHeight: 1.4 }}>
                          {t('settings.account.privateWarningDesc', 'If your AniList profile is set to Private, ShokaiShelf cannot fetch your library data. The Dashboard watchlist will be empty, and AnimeNetRec\'s accuracy will be severely reduced as it cannot analyze your past scores.')}
                        </div>
                      </div>
                    </div>
                  )}
